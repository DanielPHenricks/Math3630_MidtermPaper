...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=2]
        ...
        \draw[->, thick] (0, 0) -- (0.45, 0) node[midway, above] {$r_1$};
        \draw[->, thick] (0, 0) -- (0, 1) node[midway, right] {$r_2$};
        \draw[->, thick] (0, 0) -- (-1.07, -1.07) node[midway, above] {$r_3$};
    \end{tikzpicture}
...
to having a radius of over 1 millimeter. Greenspan wished to apply this model to understand how $r_3$ - the outer radius of the nodule - changes
...
\begin{enumerate}
    ...
    \item[(ii)] Cancer cells die when the nutrient levels, $\sigma(r, t)$ drop below a critical minimum of $\sigma_{min}.$
\end{enumerate}
